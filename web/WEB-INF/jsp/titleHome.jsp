...
<body>
    ...
    <div style="text-align: center;"><a href="/type/showSavaPage">增加分类</a></div><br/><br/>
        ...
        <tbody id="containner">
            <c:forEach var="titleBean" items="${titleList}" varStatus="status">
                <tr>
                    ...
                    <td><a href="/type/showSavaPage?id=${titleBean.id}">编辑</a></td>
...
<script>
    function deleteById(id, title){
        ...
        if (isDelete){
            window.location.href = "/type/deleteById?id="+id;
        }
    }
</script>
</html>
